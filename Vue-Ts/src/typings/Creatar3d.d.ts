declare module 'Creatar3d' {
  ...
  declare class BaseThing {
     ...
     * 分析事件
     */
    readonly thingEvent: ThingEvent
    /**
     * 状态
     */
  ...
  declare namespace Graphic {
    ...
    type Options = {
      ...
      style?: any
      attr?: any
      position: Position | string | any[] | Cesium.PositionProperty
  ...
  declare class CurveFlag {
     ...
     * 插值点数据
     */
    calculatePonits(points: any): any[]
    /**
     * 获取点数量
     */
  ...
  declare namespace CorridorPrimitive {
    ...
    type Options = {
      通用参数?: Graphic.Options
      positions: Position[] | string | any[][]
      style: Cesium.CorridorGeometry.options
      appearance?: Cesium.Appearance
      attributes?: Cesium.GeometryInstance.attributes
      depthFailAppearance?: Cesium.Appearance
      vertexCacheOptimize?: boolean
  ...
  declare namespace CylinderPrimitive {
    ...
    type Options = {
      通用参数?: Graphic.Options
      positions: Position[] | string | any[][]
      style: Cesium.CylinderGeometry.options
      appearance?: Cesium.Appearance
      attributes?: Cesium.GeometryInstance.attributes
      depthFailAppearance?: Cesium.Appearance
      vertexCacheOptimize?: boolean
  ...
  declare namespace WallPrimitive {
    ...
    type Options = {
      通用参数?: Graphic.Options
      positions: Position[] | string | any[][]
      style: Cesium.WallGeometry.options
      appearance?: Cesium.Appearance
      attributes?: Cesium.GeometryInstance.attributes
      depthFailAppearance?: Cesium.Appearance
      vertexCacheOptimize?: boolean
  ...
  declare class RoamLine extends Graphic {
     ...
     */
    on(
      type: GraphicEventType | RoamingEvent,
      callback: (...params: any[]) => any,
      context: any
    ): Graphic
    /**
     ...
     * @returns this
     */
    fire(type: GraphicEventType | RoamingEvent, params: any): Graphic
  }
  ...
  declare class ImageryProviderFactory {
     ...
     */
    static createArcGisImageryProvider(options: any): module
    /**
     * Create bing image Provider
     */
    static createBingMapsImageryProvider(options: any): module
    /**
     ...
     */
    static createTMSImageryProvider(options: any): module
    /**
     * Create Imagery Provider
     */
    static createImageryProvider(type: ImageryType, options: any): Cesium.ImageryProvider
  }
 ...
 */
  ...
  declare class TerrainFactory {
     ...
     */
    static createEllipsoidTerrain(options: any): module
    /**
     * Create url terrain
     */
    static createUrlTerrain(options: any): module
    /**
     * Create google terrain
     */
    static createGoogleTerrain(options: any): module
    /**
     * Create arcgis terrain
     */
    static createArcgisTerrain(options: any): module
    /**
     * Create vr terrain
     */
    static createVRTerrain(options: any): module
    /**
     * 创建地形服务
     */
 ...
 */
  ...
  declare class Parse {
     ...
     * @returns 坐标
     */
    static parsePosition(position: string | any[] | Position): Position
    /**
     ...
     * @returns [lng, Lat]
     */
    static parsePointCoordToArray(position: string | any[] | Position): any[]
    /**
     * Parses polyline positions to array
     */
    static parsePolylineCoordToArray(positions: string | String[] | any[][]): any[][]
    /**
     * Parses polygon positions to array
     * @param [noAlt = false] - 是否需要闭合
     */
  ...
  declare class Viewer {
     ...
     * @returns this
     */
    addTerrain(terrain: Cesium.TerrainProvider): Viewer
    /**
